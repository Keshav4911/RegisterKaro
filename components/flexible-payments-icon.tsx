...
import styles from "./flexible-payments-icon.module.css";

export type FlexiblePaymentsIconType = {
  className?: string;
};

const FlexiblePaymentsIcon: NextPage<FlexiblePaymentsIconType> = ({
  className = "",
}) => {
  return (
    <section className={[styles.flexiblePaymentsIcon, className].join(" ")}>
      <div className={styles.flexiblePaymentsIconInner}>
        <img
      ...
      <div className={styles.section}>
        ...
        <div className={styles.shrutiTitle}>
          <DivswiperSlide
          ...
          <div className={styles.divswiperSlide}>
            ...
            <div className={styles.divswiperSlideInner}>
              <div className={styles.frameParent}>
                <div className={styles.clientFeedbackParent}>
                  ...
                  <div className={styles.vartikaTestimonial}>
                    <div className={styles.vartika}>
                      <img
          ...
          <div className={styles.divswiperSlide1}>
            ...
            <div className={styles.beforeParent}>
              ...
              <div className={styles.whyLaunchwise}>
...
export default FlexiblePaymentsIcon;
